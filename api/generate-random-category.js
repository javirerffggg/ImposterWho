...
export default async function handler(req, res) {
    ...
    const prompt = `Para un juego de mesa llamado "Imposter Who?", inventa un tema o categoría de palabras divertido y original. Luego, genera una lista de 15 palabras en español para esa categoría, divididas en tres niveles de dificultad: 5 fáciles, 5 medias y 5 difíciles. Las palabras fáciles deben ser muy comunes y directamente relacionadas con el tema. Las palabras medias deben ser un poco más específicas pero aún reconocibles. Las palabras difíciles deben ser técnicas, raras o relacionadas de forma más abstracta. Devuelve el resultado exclusivamente en formato JSON, sin texto adicional antes o después. El formato debe ser: {"name": "Nombre de la Categoría Inventada", "words": {"easy": ["palabra1", "palabra2", "palabra3", "palabra4", "palabra5"], "medium": ["palabra1", "palabra2", "palabra3", "palabra4", "palabra5"], "hard": ["palabra1", "palabra2", "palabra3", "palabra4", "palabra5"]}}`;
